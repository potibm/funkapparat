...
- **Go backend**: `backend/` (module `github.com/potibm/funkapparat`)
...
Docker image check: `mise run docker:build` (uses a custom `funkapparat-builder` buildx builder)
